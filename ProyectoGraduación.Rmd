...
ui <- navbarPage(
  ...
  tabPanel(title = "Análisis General", 
           ...
           fluidRow(
             ...
             "Tabla",withSpinner(tableOutput("tabla1"), type = 3, color.background = "#060606", color = "#EEEEEE" )
           )
           ),  
  ...
  tabPanel(title = "Delitos por provincia", 
           ...
           fluidRow(
             column(6, plotOutput("top_cantones")),
...
server <- function(input, output, session) {
  ...
  observeEvent(input$provincia, {
    ...
    # Obtiene valores distintos de provincias para la region elegida
  ...
  observeEvent(input$delito, {
    ...
    # Obtiene valores distintos de cantones para la provincia y region elegida
  ...
  output$top_cantones <- renderPlot({
    datos_provincia() |> 
      group_by(canton) |> 
      summarise(Total = n()) |> 
      arrange(desc(Total)) |> 
